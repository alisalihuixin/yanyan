var t, a, e = require("../../microeco/runtime/helpers/interopRequireDefault")(require("../../microeco/runtime/helpers/defineProperty")), i = getApp(), s = i.requirejs("core"), n = i.requirejs("wxParse/wxParse"), o = i.requirejs("biz/diypage"), r = i.requirejs("biz/diyform"), d = i.requirejs("biz/goodspicker"), u = (i.requirejs("foxui"), 
i.requirejs("jquery"));
...
Page((a = {
    ...
    onLoad: function(t) {
        ...
        // console.log(wx.getStorageSync('userinfowxc6e37c5fb16d6eca'))
        // let userinfo = wx.getStorageSync('userinfowxc6e37c5fb16d6eca')
        // if(!userinfo){
        //     wx.navigateTo({
    ...
    onShow: function() {
        getApp().requirejs('core').get('diypage', {
            type: 'home',
        }, (t) => {
            this.setData({
                diypages: t.diypage
